 ...
 * @author marcelocaser
 */
public class PortalWebController extends Controller implements PortalWebConstantes {
     ...
     * @return UsuarioTO
     */
    public WebUsuariosTO getUsuarioLogado() {
        return (WebUsuariosTO) getParamSession(EnumSecurity.USUARIO_LOGADO);
    }
