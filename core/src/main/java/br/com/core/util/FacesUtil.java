...
public class FacesUtil {
    ...
    public static String getRealPathFile(FacesContext ctx, String file) {
        return ctx.getExternalContext().getRealPath(file);
    }
    ...
    /**
     * Constroi um objeto MethodExpression utilizado na chamado a "action" ou
     * "actionListener"
     *
     * @param ctx
     * @param expression
    ...
    /**
     * Constroi um objeto ValueExpression utilizado na chamado a
     * "actionListener"
     *
     * @param ctx
     * @param expression
